...
def test_marginals_asym_log_bary_with_different_grid_uniform_density_with_debiasing(
    n1, n2, members, m1, m2, L, grid_type
):
...
@pytest.mark.parametrize(
    ...
    [
        (11, 10, 3, 5, 7, 0.9, "flat"),
        (10, 10, 4, 13, 8, 1.5, "tensor"),
        (12, 11, 3, 9, 9, 2.0, "tuple"),
    ],
)  # noqa: E501
def test_marginals_asym_log_bary_with_all_different_grids_with_debiasing(
    n1, n2, members, m1, m2, L, grid_type
):
...
def test_marginals_asym_log_bary_with_all_different_grids_without_debiasing(
    n1, n2, members, m1, m2, L, grid_type
):
